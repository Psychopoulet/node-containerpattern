...
describe("clear", () => {
	...
	it("should check normal running", () => {
		...
		assert.strictEqual(Object.keys(container.skeletons).length, 1, "initialized skeletons size is invalid");
		...
		assert.strictEqual(container.size, 0, "cleaned data size is invalid");
		assert.strictEqual(Object.keys(container.skeletons).length, 0, "cleaned skeletons size is invalid");
